...
const ToDoList = () => {
  ...
  const handleClose = async () => {
    ...
    await axios
      .post(
        "https://2lilsddaz7.execute-api.eu-west-1.amazonaws.com/dev/get-tasks-by-username",
        { username }
      )
      .then((res) => {
  ...
  const getTaskDetails = async (id) => {
    ...
    try {
      const response = await axios.post(
        "https://2lilsddaz7.execute-api.eu-west-1.amazonaws.com/dev/get-single-task",
        {
          id,
        }
      );
